...
Get-GPO -Name "MSFT Windows Server 2022 - Domain Controller" | New-GPLink -Target "OU=Domain Controllers,DC=sec,DC=core"
Get-GPO -Name "MSFT Windows 10 21H2 - Computer" | New-GPLink -Target "OU=Computers,DC=sec,DC=core"
Get-GPO -Name "MSFT Windows 10 21H2 - User" | New-GPLink -Target "OU=AllUsers,DC=sec,DC=core"